...
const Button: FunctionComponent<ButtonProps> = ({ icon, onClick, text, flat = false }) => {
  return (
    <button
      type='button'
      ...
      focus:ring-2 dark:bg-dm-dark-blue dark:hover:bg-dm-very-dark-blue dark:text-dmlm-white`}
      onClick={onClick}>
      {icon || null}
      {text}
    </button>
